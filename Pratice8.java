...
//!Check how many operators/roundingmode!?
BigDecimal test1 = BigDecimal.valueOf(100000.54552);
BigDecimal test2 = BigDecimal.valueOf(0.0045);
//test1.abs();
//test1.byteValue();
//test1.doubleValue();
//test1.intValue();
...
//test1.shortValue();
//test1.floatValue();
//System.out.println(test1.scaleByPowerOfTen(5).toString());
